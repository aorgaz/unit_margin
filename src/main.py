...
def main():
    ...
    manual_start_date = "20230301"            # Example: "20240101" (YYYYMMDD)
    manual_end_date = "20230331"              # Example: "20240131" (YYYYMMDD)
    manual_markets = ["MIC"] # Example: ["PDBF", "PDBC"] - Set to None to run all
